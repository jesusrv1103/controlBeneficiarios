...
public function Guardar(){
  try {
    ...
    if($verificaLocalidad!=null && isset($_REQUEST['nuevoRegistro'])){
      ...
      $catalogos=true;
      $nuevoRegistro=true;
      $this->mensaje="La clave de la localidad que esta intentando ingresar ya existe. Pongase en contacto con el administrador de la Unidad de Planeación para que le proporcione correctamente una nueva clave de localidad.";
      $this->Index();
    }else{
      if(!isset($_REQUEST['nuevoRegistro'])){
