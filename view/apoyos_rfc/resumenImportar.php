        ...
        <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
          ...
          <div class="col-md-5">
            <div class="btn-group pull-right" style="margin-right: 10px;">
              <b> 
               <div class="btn-group">
                 <a href="?c=apoyosrfc"><i class="fa fa-mail-reply"></i> Terminar</a>
               </div>
             </b>
           </div>
         </div>
      ...
      <form action="?c=apoyos&a=Crud" enctype="multipart/form-data" method="post" parsley-validate novalidate>
        <div class="modal-body">
          <div class="row">
            <div class="block-web">
              <div class="header">
                <h3 class="content-header h3subtitulo">&nbsp;apoyos por RFC</h3>
              </div>
...
<script>
  infoRegistro = function (idApoyoRFC){
    var idApoyoRFC=idApoyoRFC;
    $.post("index.php?c=apoyosrfc&a=Inforegistro", {idApoyoRFC: idApoyoRFC}, function(info) {
