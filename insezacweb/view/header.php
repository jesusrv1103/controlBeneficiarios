      ...
      <div class="left_nav">
        ...
        <div class="left_nav_slidebar">
          <ul>
            ...
            <li class="left_nav_active theme_border">
              <a href="javascript:void(0);">
                <i class="fa fa-home"></i> Administración 
                <span class="left_nav_pointer"></span>
              </a>
            </li>
            ...
            <li> <a href="javascript:void(0);"> <i class="fa fa-users icon"></i> Beneficiarios <span class="plus"><i class="fa fa-plus"></i></span> </a>
              <ul>
                <li> <a href="todo.html"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Registrar beneficiaro</b> </a> </li>
                <li> <a href="task.html"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Importar datos</b> </a> </li>
                <li> <a href="notes.html"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Consultar datos</b> </a> </li>

              </ul>
            </li>
            <li class="left_nav_active theme_border">
              <a href="javascript:void(0);">
                <i class="fa fa-home"></i> Beneficiarios
                <span class="left_nav_pointer"></span>
              </a>
            </li>
            <li> <a href="javascript:void(0);"> <i class="fa fa-edit"></i> Beneficiarios <span class="plus"><i class="fa fa-plus"></i></span></a>
              <ul>
               <li> <a href="todo.html"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Registrar beneficiaro</b> </a> </li>
               <li> <a href="task.html"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Importar datos</b> </a> </li>
               <li> <a href="notes.html"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Consultar datos</b> </a> </li>
