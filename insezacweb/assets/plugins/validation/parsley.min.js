  ...
  var Validator = function ( options ) {
    ...
    */
    this.messages = {
      ...
      , type: {
            email:      "Este campo debe contener un correo electronico válido."
          , url:        "Este campo debe contener una url válida."
          , urlstrict:  "Este campo debe contener url válida."
          , number:     "Este campo debe contener solo números."
          , digits:     "Este campo debe contener un digito."
          , dateIso:    "This value should be a valid date (YYYY-MM-DD)."
          , alphanum:   "This value should be alphanumeric."
          , phone:      "Este campo debe contener un número telefonico válido."  
          , password:  "La contraseña debe contener como minimo 8 caracteres y una letra mayuscula."        
        }
  ...
  ParsleyField.prototype = {
    ...
    */
    , bindHtml5Constraints: function () {
      ...
      if ( 'undefined' !== typeof type && new RegExp( type, 'i' ).test( 'email url number range tel password' ) ) {
